...
const DayTab = async ({wallets, categories, userSettings}: {wallets: Wallet[], categories: Category[], userSettings: UserSettings}) => {
  ...
  return (
    <div>
      ...
      <div className="">{format(startDate, "dd MMMM", {locale: uk})}</div>
      <div className="">
